"""
Driver for HD44780 LCD screen
https://forum.micropython.org/viewtopic.php?f=2&t=354
...
def init_lcd():
    ...
    """
    Return LCD controller instance
    """

    rs = pyb.Pin("Y1", pyb.Pin.OUT_PP)
    e = pyb.Pin("Y2", pyb.Pin.OUT_PP)
    d1 = pyb.Pin("Y3", pyb.Pin.OUT_PP)
    d2 = pyb.Pin("Y4", pyb.Pin.OUT_PP)
    d3 = pyb.Pin("Y5", pyb.Pin.OUT_PP)
    d4 = pyb.Pin("Y6", pyb.Pin.OUT_PP)
    lcd = GpioLcd(rs, e, d1, d2, d3, d4)
    return lcd
